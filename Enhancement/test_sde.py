...
def main():
    parser = argparse.ArgumentParser(
        description='SDE low-light image enhancement using Retinexformer')
    ...
    output_dir = args.output_dir or osp.join('results', 'SDE', config, checkpoint)
